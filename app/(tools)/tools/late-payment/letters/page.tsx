...
export default function LettersPage() {
  ...
  function onSubmit(data: LetterInput) {
    const output = generateLetter(data);
    setLetter(output);
  }
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <p className="mt-3 max-w-2xl text-text-secondary leading-relaxed">
        Generate professional payment chasing letters in four escalating stages.
        Each letter is drafted in accordance with UK business practice and, where
        relevant, references the Late Payment of Commercial Debts (Interest) Act
        1998.
      </p>
