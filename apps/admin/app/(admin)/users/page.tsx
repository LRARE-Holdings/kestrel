      ...
      <form method="GET" action="/users" className="flex gap-3">
        <div className="relative flex-1 max-w-md">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 text-sm bg-surface border border-border rounded-lg placeholder:text-text-muted focus:outline-none focus:ring-2 focus:ring-kestrel/20 focus:border-kestrel transition-colors"
          />
        </div>
        <button
          type="submit"
        ...
        {search && (
          <Link
            href="/users"
            className="px-4 py-2.5 text-sm font-medium text-text-secondary bg-surface border border-border hover:bg-stone/30 rounded-lg transition-colors"
          >
            Clear
          </Link>
        )}
