...
export default function AboutPage() {
  return (
    <div className="mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8 2xl:px-12">
      {/* ═══ HERO ═══ */}
      <section className="relative flex min-h-[60vh] items-center overflow-hidden pt-8">
        <div className="absolute -top-24 right-1/4 h-[400px] w-[400px] rounded-full bg-kestrel/[0.03] blur-[100px]" />
        <div className="absolute -bottom-32 left-1/3 h-[300px] w-[300px] rounded-full bg-sage/[0.05] blur-[80px]" />

        <div className="relative z-10 max-w-3xl">
          <p className="animate-fade-up text-xs font-semibold uppercase tracking-[0.2em] text-kestrel">
            About Kestrel
          </p>
          <h1 className="animate-fade-up delay-100 mt-6 font-display text-4xl font-bold leading-[1.1] tracking-tight text-ink sm:text-5xl lg:text-6xl">
            The space between
            <br />
          ...
          <p className="animate-fade-up delay-200 mt-8 max-w-xl text-lg leading-relaxed text-text-secondary">
      ...
      <ScrollSection className="pb-6">
        <div className="rounded-2xl border border-border-subtle/60 bg-white/70 p-8 shadow-sm backdrop-blur-xl sm:p-12">
          ...
          <ScrollStagger stagger={0.1} className="mx-auto mt-16 grid max-w-3xl gap-4 sm:grid-cols-2">
            {[
              ...
              <StaggerItem key={item.no}>
                <div className="rounded-xl border border-border-subtle/60 bg-cream/50 p-6 transition-all duration-300 hover:border-kestrel/20 hover:-translate-y-0.5 hover:shadow-[var(--shadow-sm)]">
      ...
      <ScrollSection className="pb-6">
        <div className="rounded-2xl border border-border-subtle/60 bg-white/70 p-8 shadow-sm backdrop-blur-xl sm:p-12">
          ...
          <ScrollStagger stagger={0.12} className="mt-12 grid gap-4 sm:grid-cols-2">
            {values.map((value) => (
              <StaggerItem key={value.title}>
                <div className="group relative rounded-xl border border-border-subtle/60 bg-cream/50 p-6 transition-all duration-300 hover:border-kestrel/20 hover:-translate-y-0.5 hover:shadow-[var(--shadow-md)]">
